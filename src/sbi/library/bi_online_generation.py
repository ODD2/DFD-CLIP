...
class BIOnlineGeneration():
    ...
    def get_blended_face(self, background_face_path):
        ...
        foreground_face = sktransform.resize(foreground_face, (aug_size, aug_size),
                                             preserve_range=True).astype(np.uint8)
        background_face = sktransform.resize(background_face, (aug_size, aug_size),
                                             preserve_range=True).astype(np.uint8)
